...
│   └── features.parquet   # merged feature matrix
│
├── DataPipelines/         # EDA & feature engineering
│   ├── DataViz_v2.ipynb
│   └── DataPrep_v2.ipynb
│
├── ProjectCode/
│   ├── rl_env/            # custom OpenAI Gym environment
│   ├── agents/            # DQN, PPO, A2C implementations (PyTorch)
│   ├── baselines/         # classical ML benchmarks
│   ├── train.py           # RL training entry-point
│   └── evaluate.py        # back-testing & metrics
│
├── tests/                 # unit tests
├── Research Papers/       # reference literature (PDFs)
├── presentation/          # academic defence slides
